...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    fullDescription: 'Commissioned by Sparkassenstiftung für internationale Kooperation (Finanzgruppe). Developed in collaboration with Vulcan SRL (La Paz, Bolivia) and Planifica.bo, this sandbox project introduced a mobile-friendly financial calculator designed to help users in South America understand the long-term effects of savings and spending. The tool was part of the Sparkassenstiftung\'s international "Simulator" program and serves as a prototype for replication across other Global South contexts. Led end-to-end UX/UI design, from research to high-fidelity prototype. Conducted contextual user research in La Paz using interviews, usability tests, and field observations to ensure cultural and linguistic relevance. Applied human-centered design and UX standards (including Nielsen heuristics, accessibility, and responsive principles) to make the interface intuitive for first-time financial-tool users. Created interactive calculator components showing real-world financial scenarios and future outcomes, supporting Sparkassenstiftung\'s "learn by doing" educational model. Collaborated on implementation guidelines and analytics touchpoints for monitoring adoption and usability. The product functions as a replicable model for financial-literacy tools in emerging markets—adaptable to other Latin American and Global South communities through scalable design systems, localization strategies, and user-validated UX frameworks.',
