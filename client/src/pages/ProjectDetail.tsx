                ...
                <div className="mt-12">
                  ...
                  >
                    <h3 
                      ...
                      style={{ color: 'var(--text-primary)' }}
                    >
                      Project Thesis & Critical Inquiry
                    </h3>
                    ...
                    <p 
                      ...
                      style={{ color: 'var(--text-secondary)' }}
                    >
                      This project is not a technological panacea; it is a critical inquiry into the role of AI in complex social and learning systems. Artecno challenges the dominant narrative that AI must replace human educators or simplify learning.
                    </p>
                    ...
                    <p 
                      ...
                      style={{ color: 'var(--text-secondary)' }}
                    >
                      The core motivation is to move beyond passive content delivery and use AI to help users structure their lived experience and implicit cognitive patterns, making self-knowledge the primary output, not just standardized lessons.
                    </p>
                  </div>
                  ...
                  >
                    <h3 
                      ...
                      style={{ color: 'var(--text-primary)' }}
                    >
                      My Role: AIX Designer & Developer
                    </h3>
                    ...
                    <p 
                      ...
                      style={{ color: 'var(--text-secondary)' }}
                    >
                      As the sole creator, I was responsible for the entire project lifecycle, from UX research and the AIX Strategy (defining how AI interacts with human complexity) to front-end development and the design of the non-linear data model.
                    </p>
                    ...
                    <ul 
                      className="space-y-2 font-['Roboto_Flex'] text-lg"
                      style={{ color: 'var(--text-secondary)' }}
                    >
                      <li>• AI Experience (AIX) Design & Critical Strategy</li>
                      <li>• UX/UI Design</li>
                  ...
                  <h3 
                    ...
                    style={{ color: 'var(--text-primary)' }}
                  >
                    The Artecno Ecosystem: Modules for Self-Interrogation
                  </h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    >
                      <h4 
                        ...
                        style={{ color: 'var(--text-primary)' }}
                      >
                        Module 1: Implicit Cognitive Assessment
                      </h4>
                      <p 
                        className="text-sm font-medium mb-2"
                        style={{ color: 'var(--accent-primary)' }}
                      >
                        The Question: Can AI detect how a user thinks, not just what they know?
                      </p>
                      <p 
                        className="text-base leading-relaxed font-['Roboto_Flex']"
                        style={{ color: 'var(--text-secondary)' }}
                      >
                        Analyzes implicit behavior (mouse movement, hesitation, decision speed) to build a baseline cognitive and socio-emotional profile, revealing underlying decision patterns.
                      </p>
                    </div>
                    ...
                    >
                      <h4 
                        ...
                        style={{ color: 'var(--text-primary)' }}
                      >
                        Module 2: Leadership Journey Timeline
                      </h4>
                      <p 
                        className="text-sm font-medium mb-2"
                        style={{ color: 'var(--accent-primary)' }}
                      >
                        The Question: How can we turn subjective memory into objective data?
                      </p>
                      <p 
                        className="text-base leading-relaxed font-['Roboto_Flex']"
                        style={{ color: 'var(--text-secondary)' }}
                      >
                        Users plot significant life events while the AI acts as a structured interviewer, transforming qualitative autobiography into analyzable data.
                      </p>
                    </div>
                    ...
                    >
                      <h4 
                        ...
                        style={{ color: 'var(--text-primary)' }}
                      >
                        AI Synthesis: Narrative Generation
                      </h4>
                      <p 
                        className="text-base leading-relaxed font-['Roboto_Flex']"
                        style={{ color: 'var(--text-secondary)' }}
                      >
                        Cross-references implicit cognitive profile with explicit timeline data to generate holistic, narrative-based leadership assessment designed to prompt self-questioning.
                      </p>
                    </div>
                    ...
                    >
                      <h4 
                        ...
                        style={{ color: 'var(--text-primary)' }}
                      >
                        Module 3: Personalized Learning
                      </h4>
                      <p 
                        className="text-sm font-medium mb-2"
                        style={{ color: 'var(--accent-primary)' }}
                      >
                        The Question: Can learning close the gap between self-perception and behavior?
                      </p>
                      <p 
                        className="text-base leading-relaxed font-['Roboto_Flex']"
                        style={{ color: 'var(--text-secondary)' }}
                      >
                        AI assistant provides personalized tutorials framed around tension points (e.g., "Your stated value of empathy conflicts with your fast decision speed").
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 mb-8">
                    <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                      <img
                        src={artecno1}
                        alt="ARTECNO curriculum framework showing 5-week structure"
                        className="w-full h-auto"
                        data-testid="img-artecno-1"
                      />
                      <div className="p-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                        <h5 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Unit 1 MAYA Curriculum Framework</h5>
                        <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>5-week structure integrating fundamentals, prototyping, and metacognitive reflection</p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                      <img
                        src={artecno2}
                        alt="Social Design Problem Scope diagram"
                        className="w-full h-auto"
                        data-testid="img-artecno-2"
                      />
                      <div className="p-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                        <h5 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Social Design Problem Scope</h5>
                        <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Addressing device dependency, disembodied ed-tech, data exploitation, and digital divides</p>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                        <img
                          ...
                          alt="Somatik somatic pause interface"
                          className="w-full h-auto"
                          data-testid="img-artecno-screenshot-1"
                        />
                        <div className="p-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                          <h5 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Somatik Module</h5>
                          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Somatic pause and body reconnection tool</p>
                        </div>
                      </div>
                      ...
                      <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                        <img
                          ...
                          alt="Pattern creation interface"
                          className="w-full h-auto"
                          data-testid="img-artecno-screenshot-2"
                        />
                        <div className="p-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                          <h5 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Piedras/Patrones Tool</h5>
                          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Pattern creation and rhythm builder</p>
                        </div>
                      </div>
                      ...
                      <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                        <img
                          ...
                          alt="Cognitive assessment questionnaire"
                          className="w-full h-auto"
                          data-testid="img-artecno-screenshot-3"
                        />
                        <div className="p-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                          <h5 className="font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Implicit Assessment</h5>
                          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Behavioral analysis through interaction patterns</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden" style={{ boxShadow: 'var(--shadow)' }}>
                      <img
                        src={artecno3}
                        alt="ARTECNO title screen"
                        className="w-full h-auto"
                        data-testid="img-artecno-3"
                      />
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <p 
                      ...
                      style={{ color: 'var(--text-primary)' }}
                    >
                      Educational purposes only. All data stored locally. Designed and developed by Edwin Mauricio Olivera, Design for Social Innovation 2025, SVA NYC.
                    </p>
                  </div>
                </div>
              )}
