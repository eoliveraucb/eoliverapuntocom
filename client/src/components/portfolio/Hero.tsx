            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="text-[36px] font-light">a showcase of my <a href="#projects" className="bg-[#3d445c] underline decoration-purple-500 decoration-2 hover:decoration-purple-700 transition-all duration-300 text-[#e0c9f5] font-semibold" style={{ color: 'inherit', fontWeight: linkWeights.teaching }}>teaching experience</a>, <a href="#design" className="underline decoration-cyan-500 decoration-2 hover:decoration-cyan-700 transition-all duration-300 text-[#d5f5f7]" style={{ color: 'inherit', fontWeight: linkWeights.practice }}>professional practice</a> and <a href="https://medium.com/@emauric.io" target="_blank" rel="noopener noreferrer" className="underline decoration-orange-500 decoration-2 hover:decoration-orange-700 transition-all duration-300 text-[#f2dec2]" style={{ color: 'inherit', fontWeight: linkWeights.experiments }}>thought experiments</a>.</div>
                <div
                  style={{
