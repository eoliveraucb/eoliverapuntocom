            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="text-[36px]">a showcase of my <a href="#projects" className="underline decoration-purple-500 decoration-2 hover:decoration-purple-700 transition-all duration-300 text-[#d2bfe0]" style={{ color: 'inherit', fontWeight: linkWeights.teaching }}>teaching experience</a>, <a href="#design" className="underline decoration-cyan-500 decoration-2 hover:decoration-cyan-700 transition-all duration-300 text-[#cae6eb]" style={{ color: 'inherit', fontWeight: linkWeights.practice }}>professional practice</a> and <a href="https://medium.com/@emauric.io" target="_blank" rel="noopener noreferrer" className="underline decoration-orange-500 decoration-2 hover:decoration-orange-700 transition-all duration-300" style={{ color: 'inherit', fontWeight: linkWeights.experiments }}>thought experiments</a>.</div>
                <div
                  style={{
