            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="text-[36px] font-light text-white">a showcase of my <a href="#projects" className="bg-[transparent] underline decoration-purple-500 decoration-2 hover:decoration-purple-700 transition-all duration-300 text-[#e0c9f5] font-semibold" style={{ color: '#efe3ff', fontWeight: linkWeights.teaching }}>teaching experience</a>, <a href="#design" className="underline decoration-cyan-500 decoration-2 hover:decoration-cyan-700 transition-all duration-300 text-[#d5f5f7] font-semibold" style={{ color: '#e3faff', fontWeight: linkWeights.practice }}>professional practice</a> and <a href="https://medium.com/@emauric.io" target="_blank" rel="noopener noreferrer" className="underline decoration-green-500 decoration-2 hover:decoration-orange-700 transition-all duration-300 text-[#f2dec2] font-semibold" style={{ color: '#e3ffeb', fontWeight: linkWeights.experiments }}>thought experiments</a>.</div>
                <div
                  style={{
